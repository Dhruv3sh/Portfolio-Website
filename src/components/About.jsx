...
const About = () => {
  return (
    ...
    <div className=' flex flex-row justify-center items-center w-full h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white'>
      ...
      <div name="about" className='flex flex-row justify-center items-center w-full h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white'>
        ...
        <div className='h-96 w-96 pt-[74px] pr-6'>
            <img className=' h-80 rounded-md shadow-md shadow-slate-900' src={Ui} alt="gif" />
        </div>
      </div>
    </div>
  )
